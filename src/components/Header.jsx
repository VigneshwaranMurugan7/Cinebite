...
const Header = () => {
      ...
      const LogOutButton =  () => {
        ...
        return(
          user && <button className='text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 p-2' onClick={handleLogOut}>
            LogOut
          </button>
        )
      }
...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <NavLink  to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src={backup} className="h-8" alt="Flowbite Logo" />
